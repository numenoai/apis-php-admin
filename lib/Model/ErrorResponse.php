...
class ErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => 'int',
        'message' => 'string',
        'errors' => '\NumenoAdmin\Model\ErrorDetail[]'
    ];
    ...
    */
     ...
     * Sets status
     *
     * @param int $status HTTP status code of the error
     *
     * @return self
     */
     ...
     * Gets errors
     *
     * @return \NumenoAdmin\Model\ErrorDetail[]|null
     */
     ...
     * Sets errors
     *
     * @param \NumenoAdmin\Model\ErrorDetail[]|null $errors Details about specific errors (if any)
     *
     * @return self
     */
