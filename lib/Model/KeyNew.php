 ...
 */
class KeyNew implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyNew';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['scopes']) && (count($this->container['scopes']) > 256)) {
            $invalidProperties[] = "invalid value for 'scopes', number of items must be less than or equal to 256.";
        }
     ...
     * Sets scopes
     *
     * @param string[]|null $scopes The Scopes to give the new Key access to.
     *
     * @return self
     */
    public function setScopes($scopes)
    {
        ...
        if ((count($scopes) > 256)) {
            throw new \InvalidArgumentException('invalid value for $scopes when calling KeyNew., number of items must be less than or equal to 256.');
        }
